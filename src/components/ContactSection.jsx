...
export const ContactSection = () => {
    ...
    return <section id="contact" className="py-24 px-4 relative bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
            <h2 className="text-3l md:text-4xl font-bold mb-4 text-center">
                Get In <span className="text-primary">Touch</span>
            </h2>

            <p className="text-center text-muted-foreground mb-12 mx-auto">
                Have a project in mind orwant to collaborate? Feel free to reach out.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-6 justify-center">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="emailto:ajinkyareact9@gmail.com">ajinkyareact9@gmail.com</a>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <a href="tel:11234567890">+911234567890</a>
                            </div>
                        </div>
                ...
                <div className="bg-card p-8 rounded-lg shadow-xs card-hover" onSubmit={handleSubmit}>
