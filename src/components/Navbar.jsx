        ...
        <div className="container flex items-center justify-between">
            ...
            href="#hero">
                <span className="relative z-10">
                    <span className="text-glow text-foreground"> Ajinkya's</span>
                   Portfolio
                </span>
            </a>
            ...
            {/* {mobile nav} */}
            <button onClick={() => setIsMeuOpened((prev)=> !prev) }
            ...
            <div className={cn(
                ...
                "tranisiton-all duratio-300 md:hidden",
